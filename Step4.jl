...
# num_overlap is the maximum overlap of players between the lineups that you createx
num_overlap = 7
...
function create_lineups(num_lineups, num_overlap, path_hitters, path_pitchers, formulation, path_to_output)
    ...
    #=
    Process the position information in the hitters file to populate the catchers, firstbasemen, secondbasemen, thirdbasemen, shortstops, outfielders with the corresponding correct information
    =#
    for i =1:num_hitters
