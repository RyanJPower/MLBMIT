...
for j = 1:size(tracer)[2]
    catchers_in_lineup = fill("",(num_lineups,8))
    firstbasemen_in_lineup = fill("",(num_lineups,8))
    secondbasemen_in_lineup = fill("",(num_lineups,8))
    thirdbasemen_in_lineup = fill("",(num_lineups,8))
    shortstops_in_lineup = fill("",(num_lineups,8))
    outfielders_in_lineup = fill("",(num_lineups,8))
    hitter_num_lineup = fill("",(num_lineups,8))
    for i =1:num_hitters
        if tracer[i,j] == 1
            #hitter_num_lineup=vcat(hitter_num_lineup,fill(i,1))
            if hitters[i,:Position] == "C"
                catchers_in_lineup=hcat(catchers_in_lineup,fill(j,1))
                firstbasemen_in_lineup=hcat(firstbasemen_in_lineup,fill(j,0))
                secondbasemen_in_lineup=hcat(secondbasemen_in_lineup,fill(j,0))
                thirdbasemen_in_lineup=hcat(thirdbasemen_in_lineup,fill(j,0))
                shortstops_in_lineup=hcat(shortstops_in_lineup,fill(j,0))
                outfielders_in_lineup=hcat(outfielders_in_lineup,fill(j,0))
            elseif hitters[i,:Position] == "1B"
                catchers_in_lineup=hcat(catchers_in_lineup,fill(j,0))
                firstbasemen_in_lineup=hcat(firstbasemen_in_lineup,fill(j,1))
                secondbasemen_in_lineup=hcat(secondbasemen_in_lineup,fill(j,0))
                thirdbasemen_in_lineup=hcat(thirdbasemen_in_lineup,fill(j,0))
                shortstops_in_lineup=hcat(shortstops_in_lineup,fill(j,0))
                outfielders_in_lineup=hcat(outfielders_in_lineup,fill(j,0))
            elseif hitters[i,:Position] == "2B"
                catchers_in_lineup=hcat(catchers_in_lineup,fill(j,0))
                firstbasemen_in_lineup=hcat(firstbasemen_in_lineup,fill(j,0))
                secondbasemen_in_lineup=hcat(secondbasemen_in_lineup,fill(j,1))
                thirdbasemen_in_lineup=hcat(thirdbasemen_in_lineup,fill(j,0))
                shortstops_in_lineup=hcat(shortstops_in_lineup,fill(j,0))
                outfielders_in_lineup=hcat(outfielders_in_lineup,fill(j,0))
            elseif hitters[i,:Position] == "3B"
                ...
                firstbasemen_in_lineup=hcat(firstbasemen_in_lineup,fill(j,0))
                secondbasemen_in_lineup=hcat(secondbasemen_in_lineup,fill(j,0))
                thirdbasemen_in_lineup=hcat(thirdbasemen_in_lineup,fill(j,1))
                shortstops_in_lineup=hcat(shortstops_in_lineup,fill(j,0))
                outfielders_in_lineup=hcat(outfielders_in_lineup,fill(j,0))
            elseif hitters[i,:Position] == "SS"
                catchers_in_lineup=hcat(catchers_in_lineup,fill(j,0))
                ...
                secondbasemen_in_lineup=hcat(secondbasemen_in_lineup,fill(j,0))
                thirdbasemen_in_lineup=hcat(thirdbasemen_in_lineup,fill(j,0))
                shortstops_in_lineup=hcat(shortstops_in_lineup,fill(j,1))
                outfielders_in_lineup=hcat(outfielders_in_lineup,fill(j,0))
            elseif hitters[i,:Position] == "OF"
                catchers_in_lineup=hcat(catchers_in_lineup,fill(j,0))
                firstbasemen_in_lineup=hcat(firstbasemen_in_lineup,fill(j,0))
                ...
                thirdbasemen_in_lineup=hcat(thirdbasemen_in_lineup,fill(j,0))
                shortstops_in_lineup=hcat(shortstops_in_lineup,fill(j,0))
                outfielders_in_lineup=hcat(outfielders_in_lineup,fill(j,1))
            elseif hitters[i,:Position] == "1B/C"
                catchers_in_lineup=hcat(catchers_in_lineup,fill(j,1))
                firstbasemen_in_lineup=hcat(firstbasemen_in_lineup,fill(j,1))
                secondbasemen_in_lineup=hcat(secondbasemen_in_lineup,fill(j,0))
    ...
    println(catchers_in_lineup)
    #println(firstbasemen_in_lineup)
    #println(secondbasemen_in_lineup)
    #println(thirdbasemen_in_lineup)
    #println(shortstops_in_lineup)
    #println(outfielders_in_lineup)
    #println(hitter_num_lineup)
                ...
                if catchers[i]==1
                    ...
                    elseif outfielders[i] == 1
                        if lineup[1] != ""
                            ...
                            elseif lineup[8] == ""
                                lineup[8] = string(hitters[i,1], " ", hitters[i,2])
                            elseif lineup[6] != "" || lineup[7] != "" || lineup[7] != ""
                                lineup[1] = string(hitters[i,1], " ", hitters[i,2])
                            end
                        end
                    end
                elseif firstbasemen[i]==1
                    if secondbasemen[i] == 1
                        if lineup[2] != ""
                            lineup[3] = string(hitters[i,1], " ", hitters[i,2])
                        elseif lineup[3] != ""
                            lineup[2] = string(hitters[i,1], " ", hitters[i,2])
