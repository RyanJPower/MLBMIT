...
function one_lineup_Type_4(hitters, pitchers, lineups, num_overlap, num_hitters, num_pitchers, catchers, firstbasemen, secondbasemen, thirdbasemen, shortstops, outfielders, num_teams, hitters_teams, pitcher_opponents, team_lines, num_lines)
    ...
    # Must have two stacks of 4 within each lineup
    @defVar(m, team_stack[i=1:num_teams], Bin)
    @addConstraint(m, constr[i=1:num_teams], 4*team_stack[i] <= sum{hitters_teams[k,i]*hitters_lineup[k], k=1:num_hitters})
    @addConstraint(m, sum{team_stack[i], i=1:num_teams} == 2)
...
function create_lineups(num_lineups, num_overlap, path_hitters, path_pitchers, formulation, path_to_output)
    ...
    # catchers/firstbasemen stores the information on which players are catchers
    ...
    =#
    for i =1:num_hitters
        if hitters[i,:Position] == "C" || hitters[i,:Position] == "C/1B" || hitters[i,:Position] == "C/2B" || hitters[i,:Position] == "C/3B" || hitters[i,:Position] == "C/OF" ||
            hitters[i,:Position] == "1B/C" || hitters[i,:Position] == "2B/C" || hitters[i,:Position] == "3B/C" || hitters[i,:Position] == "OF/C"
        ...
        elseif hitters[i,:Position] == "1B" || hitters[i,:Position] == "1B/C" || hitters[i,:Position] == "1B/2B" || hitters[i,:Position] == "1B/3B" || hitters[i,:Position] == "1B/OF" ||
            hitters[i,:Position] == "C/1B" || hitters[i,:Position] == "2B/1B" || hitters[i,:Position] == "3B/1B" || hitters[i,:Position] == "OF/1B"
            ...
            shortstops=vcat(shortstops,fill(0,1))
            outfielders=vcat(outfielders,fill(0,1))
        elseif hitters[i,:Position] == "2B" || hitters[i,:Position] == "2B/1B" || hitters[i,:Position] == "2B/3B" || hitters[i,:Position] == "2B/SS" || hitters[i,:Position] == "2B/OF" ||
            hitters[i,:Position] == "1B/2B" || hitters[i,:Position] == "3B/2B" || hitters[i,:Position] == "SS/2B" || hitters[i,:Position] == "OF/2B"
            catchers=vcat(catchers,fill(0,1))
            firstbasemen=vcat(firstbasemen,fill(0,1))
            ...
            shortstops=vcat(shortstops,fill(0,1))
            outfielders=vcat(outfielders,fill(0,1))
        elseif hitters[i,:Position] == "3B" || hitters[i,:Position] == "3B/C" || hitters[i,:Position] == "3B/1B" || hitters[i,:Position] == "3B/2B" || hitters[i,:Position] == "3B/SS" || hitters[i,:Position] == "3B/OF" ||
            hitters[i,:Position] == "C/3B" || hitters[i,:Position] == "1B/3B" || hitters[i,:Position] == "2B/3B" || hitters[i,:Position] == "SS/3B" || hitters[i,:Position] == "OF/3B"
            catchers=vcat(catchers,fill(0,1))
            firstbasemen=vcat(firstbasemen,fill(0,1))
            secondbasemen=vcat(secondbasemen,fill(0,1))
            ...
            shortstops=vcat(shortstops,fill(0,1))
            outfielders=vcat(outfielders,fill(0,1))
        elseif hitters[i,:Position] == "SS" || hitters[i,:Position] == "SS/2B" || hitters[i,:Position] == "SS/3B" || hitters[i,:Position] == "SS/OF" || hitters[i,:Position] == "2B/SS" ||
            hitters[i,:Position] == "3B/SS" || hitters[i,:Position] == "OF/SS"
            catchers=vcat(catchers,fill(0,1))
            firstbasemen=vcat(firstbasemen,fill(0,1))
            secondbasemen=vcat(secondbasemen,fill(0,1))
            thirdbasemen=vcat(thirdbasemen,fill(0,1))
            ...
            outfielders=vcat(outfielders,fill(0,1))
        elseif hitters[i,:Position] == "OF" || hitters[i,:Position] == "OF/C" || hitters[i,:Position] == "OF/1B" || hitters[i,:Position] == "OF/2B" || hitters[i,:Position] == "OF/3B" || hitters[i,:Position] == "OF/SS" ||
            hitters[i,:Position] == "C/OF" || hitters[i,:Position] == "1B/OF" || hitters[i,:Position] == "2B/OF" || hitters[i,:Position] == "3B/OF" || hitters[i,:Position] == "SS/OF"
            catchers=vcat(catchers,fill(0,1))
            firstbasemen=vcat(firstbasemen,fill(0,1))
            secondbasemen=vcat(secondbasemen,fill(0,1))
            thirdbasemen=vcat(thirdbasemen,fill(0,1))
    ...
    for j = 1:size(tracer)[2]
        ...
        for i =1:num_hitters
            if tracer[i,j] == 1
                ...
                elseif outfielders[i] == 1
                    ...
                    elseif lineup[9] ==""
                        lineup[9] = string(hitters[i,1], " ", hitters[i,2])
                    elseif lineup[10] == ""
                        lineup[10] = string(hitters[i,1], " ", hitters[i,2])
                    end
                end
            end
        end
        for i =1:num_pitchers
            if tracer[num_hitters+i,j] == 1
                lineup[1] = string(pitchers[i,1], " ", pitchers[i,2])
            elseif lineup[2] == ""
                lineup[2] = string(pitchers[i,1], " ", pitchers[i,2])
            end
        end
        for name in lineup
